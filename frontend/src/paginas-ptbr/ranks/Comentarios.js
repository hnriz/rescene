...
function RankComentarios() {
    ...
    return (
        <main className="rankingPage rank-comments">
                ...
                <div className="rankingContent containerRanks">
                    <div className="rankingMainInfo">
                        ...
                        <div className="rankingDetails">
                            <h1 className="rankingDisplayName">Top 10 Comentários</h1>

                            <span className="rankingSubtitle">Os comentários mais curtidos pela comunidade Rescene</span>
            ...
            <div className="rankingContainer">
                ...
                <nav className="rankingNav container">
                    ...
                    <a href="/top-comentarios" className="navItem active">
                        <FontAwesomeIcon icon={faComment} />
...
export default RankComentarios;