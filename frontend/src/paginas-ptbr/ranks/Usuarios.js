...
function RankUsuarios() {
    ...
    return (
        <main className="rankingPage rank-users">
                ...
                <div className="rankingContent containerRanks">
                    <div className="rankingMainInfo">
                        ...
                        <div className="rankingDetails">
                            <h1 className="rankingDisplayName">Top 10 Usuários</h1>

                            <span className="rankingSubtitle">Os usuários mais ativos da comunidade Rescene</span>
            ...
            <div className="rankingContainer">
                ...
                <nav className="rankingNav container">
                    ...
                    <a href="/top-usuarios" className="navItem active">
                        <FontAwesomeIcon icon={faUserGroup} />
